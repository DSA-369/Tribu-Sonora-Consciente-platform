...
app = rx.App()
app.add_page(index, route="/", on_load=[State.cargar_datos_db, State.cargar_notificaciones_usuario])
app.add_page(contacto_page, route="/contacto")
app.add_page(acerca_de_page, route="/acerca-de", on_load=State.cargar_datos_db)
app.add_page(detalle_guia_page, route="/biografia/[id]", on_load=State.cargar_detalle_guia) # Conexión dinámica
app.add_page(shop_page, route="/shop", on_load=State.cargar_datos_db)
...
app.add_page(servicios_page, route="/servicios", on_load=State.cargar_datos_db)
app.add_page(talleres_page, route="/talleres", on_load=State.cargar_datos_db)
